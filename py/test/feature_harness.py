# Ipify SDK feature test harness
#
...
from ipify_sdk.features import _make_feature
...
class _Ctx:
    ...
    def __init__(self, client, utility, op=None, entity=None, ctrl=None):
        ...
        self.out = {}
        self.ctrl = ctrl if ctrl is not None else IpifyControl()
        self.meta = {}
        self.op = op
        self.entity = entity
