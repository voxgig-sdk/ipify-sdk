# Ipify SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpifySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpifySDK(...) and IpifySDK.test(...) become
#      IpifySDK.test({"entity": {...}}) seeding one mock record (id "test01")
