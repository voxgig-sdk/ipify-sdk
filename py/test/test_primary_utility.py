...
from ipify_sdk.core.spec import IpifySpec
from ipify_sdk.core.result import IpifyResult
from ipify_sdk.core.response import IpifyResponse
from ipify_sdk.core.operation import IpifyOperation
from ipify_sdk.core.error import IpifyError
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = IpifySDK.test(None, None)
        ...
        class TestInitFeature(IpifyBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(IpifyBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = IpifySDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = IpifySDK.test(None, setup_opts)
