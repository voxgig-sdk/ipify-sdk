...
_runner = makeRunner(TEST_JSON_FILE, IpifySDK.test(None, None))
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = IpifySDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = IpifySDK.test(None, setup.get('a') or {})
