...
from ipify_sdk.core.control import IpifyControl
...
from ipify_sdk.core.helpers import get_ctx_prop, to_map
...
class IpifyContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, IpifyResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return IpifyError(code, msg, self)
