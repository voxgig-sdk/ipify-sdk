...
from ipify_sdk.utility import register

# Load features
from ipify_sdk.feature.base_feature import IpifyBaseFeature
from ipify_sdk.features import _has_feature, _make_feature
...
class IpifySDK:
    ...
    def get_utility(self):
        return IpifyUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IpifySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetPublicIp(self, data=None) -> "GetPublicIpEntity":
        ...
        from ipify_sdk.entity.get_public_ip_entity import GetPublicIpEntity
