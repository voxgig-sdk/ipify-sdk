...
(0, node_test_1.describe)('GetPublicIpDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-get_public_ip', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_public_ip', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.IPIFY_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IpifySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['IPIFY_TEST_GET_PUBLIC_IP_ENTID'];
...
//# sourceMappingURL=GetPublicIpDirect.test.js.map