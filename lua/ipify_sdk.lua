...
IpifySDK._make_feature = _make_feature


function IpifySDK.new(options)
  local self = setmetatable({}, IpifySDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function IpifySDK:get_utility()
  return Utility.copy(self._utility)
end


function IpifySDK:get_root_ctx()
  return self._rootctx
end


function IpifySDK:prepare(fetchargs)
...
function IpifySDK:direct(fetchargs)
...
-- by passing it.
function IpifySDK:_raw_request(fetchargs)
  local utility = self._utility
...
function IpifySDK:graphql(query, variables, ctrl)
...
function IpifySDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = IpifySDK.new(sdkopts)
  sdk.mode = "test"
