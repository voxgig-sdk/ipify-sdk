...
local GetPublicIpEntity = {}
GetPublicIpEntity.__index = GetPublicIpEntity


function GetPublicIpEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetPublicIpEntity)
  self._name = "get_public_ip"
  self._client = client
...
function GetPublicIpEntity:get_name()
  return self._name
end


function GetPublicIpEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetPublicIpEntity.new(self._client, opts)
end
...
function GetPublicIpEntity:mark_deleted()
  self._deleted = true
end


function GetPublicIpEntity:deleted()
  return true == self._deleted
end


function GetPublicIpEntity:data_set(args)
  if args ~= nil then
...
function GetPublicIpEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetPublicIpEntity:match_set(args)
  if args ~= nil then
...
function GetPublicIpEntity:match_get()
...
function GetPublicIpEntity:stream(action, args, callopts)
...
---@param reqmatch GetPublicIpLoadMatch
---@param ctrl? table
---@return GetPublicIp
---@return string? err
function GetPublicIpEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetPublicIpEntity:_run_op(ctx, post_done)
  local utility = self._utility
