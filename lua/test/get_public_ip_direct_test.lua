...
describe("GetPublicIpDirect", function()
  it("should direct-load-get_public_ip", function()
    local setup = get_public_ip_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_public_ip", setup.live and "live" or "unit")
