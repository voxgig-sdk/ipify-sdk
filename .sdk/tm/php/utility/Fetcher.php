...
class IpifyFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpifySDK/1.0)';
    ...
    public static function call(IpifyContext $ctx, string $fullurl, array $fetchdef): array
    {
