...
// Ipify SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class IpifyMakeRequest
{
    public static function call(IpifyContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new IpifyResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new IpifyResponse($fetched);
        } else {
