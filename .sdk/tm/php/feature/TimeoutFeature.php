...
class IpifyTimeoutFeature extends IpifyBaseFeature
{
    ...
    private function _with_timeout(IpifyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpifyContext $_ctx, float $ms): void
    {
        $client = $this->client;
