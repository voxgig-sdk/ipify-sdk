...
class IpifyCacheFeature extends IpifyBaseFeature
{
    ...
    private function _through(IpifyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
