...
class IpifyRbacFeature extends IpifyBaseFeature
{
    ...
    private function _required(IpifyContext $ctx): ?string
    {
    ...
    private function _reject(IpifyContext $ctx, string $required): void
    {
    ...
    private function _track(IpifyContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
