...
class IpifyRatelimitFeature extends IpifyBaseFeature
{
    ...
    private function _acquire(IpifyContext $ctx): void
    {
    ...
    private function _track(IpifyContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
