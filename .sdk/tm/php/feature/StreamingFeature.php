...
class IpifyStreamingFeature extends IpifyBaseFeature
{
    ...
    private function _iterate(IpifyResult $result): \Generator
    {
    ...
    private function _streamable(IpifyContext $ctx): bool
    {
