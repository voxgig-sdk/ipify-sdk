...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = IpifyOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(IpifyOmni::structfix($now, Struct::undef()))
                        !== json_encode(IpifyOmni::structfix($val, Struct::undef()))) {
