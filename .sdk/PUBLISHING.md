...
|---|---|---|
| `ts/` | @voxgig-sdk/ipify-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ipify-sdk \
      --repository voxgig-sdk/ipify-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ipify-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ipify-sdk --id=<id>` removes it.
