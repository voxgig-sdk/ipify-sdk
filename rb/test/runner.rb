...
module IpifyTestRunner
  ...
  def self.env_override(m)
    live = getenv("IPIFY_TEST_LIVE")
    override = getenv("IPIFY_TEST_OVERRIDE")
    ...
    explain = getenv("IPIFY_TEST_EXPLAIN")
    m["IPIFY_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = IpifyTestRunner
Helpers = IpifyHelpers
Vs = VoxgigStruct
