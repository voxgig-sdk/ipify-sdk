...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/ipify` | `npm install @voxgig-sdk/ipify` |
| Python | `voxgig-sdk-ipify` | `pip install voxgig-sdk-ipify` |
| PHP | `voxgig-sdk/ipify` | `composer require voxgig-sdk/ipify` |
| Golang | `github.com/voxgig-sdk/ipify-sdk/go` | `go get github.com/voxgig-sdk/ipify-sdk/go` |
| Ruby | `voxgig-sdk-ipify` | `gem install voxgig-sdk-ipify` |
| Lua | `voxgig-sdk-ipify` | `luarocks install voxgig-sdk-ipify` |
