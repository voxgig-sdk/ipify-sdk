...
func (sdk *IpifySDK) OptionsMap() map[string]any {
...
func (sdk *IpifySDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *IpifySDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *IpifySDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpifySDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *IpifySDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *IpifySDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("IpifySDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *IpifySDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpifySDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("IpifySDK: graphql: %s", msg)
		res["graphql"] = errors
	}
