...
type GetPublicIpEntity struct {
	name    string
	client  *core.IpifySDK
...
func NewGetPublicIpEntity(client *core.IpifySDK, entopts map[string]any) *GetPublicIpEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetPublicIpEntity) GetName() string { return e.name }
...
func (e *GetPublicIpEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetPublicIpEntity) Deleted() bool {
	return e.deleted
}


func (e *GetPublicIpEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetPublicIpEntity(e.client, opts)
}

func (e *GetPublicIpEntity) Data(args ...any) any {
...
func (e *GetPublicIpEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetPublicIp; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetPublicIpEntity) DataTyped(data ...GetPublicIp) GetPublicIp {
	if len(data) > 0 {
		return typedFrom[GetPublicIp](e.Data(asMap(data[0])))
	}
	return typedFrom[GetPublicIp](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetPublicIp (all fields
// optional at the wire level).
func (e *GetPublicIpEntity) MatchTyped(match ...GetPublicIp) GetPublicIp {
	if len(match) > 0 {
		return typedFrom[GetPublicIp](e.Match(asMap(match[0])))
	}
	return typedFrom[GetPublicIp](e.Match())
}
...
func (e *GetPublicIpEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetPublicIpEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetPublicIpLoadMatch and returns an GetPublicIp. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetPublicIpEntity) LoadTyped(reqmatch GetPublicIpLoadMatch, ctrl map[string]any) (GetPublicIp, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetPublicIp{}, err
	}
	return typedFrom[GetPublicIp](res), nil
}



func (e *GetPublicIpEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetPublicIpEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetPublicIpEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetPublicIpEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetPublicIpEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
