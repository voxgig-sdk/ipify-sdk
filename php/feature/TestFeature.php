...
// Ipify SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IpifyTestFeature extends IpifyBaseFeature
{
    ...
    public function init(IpifyContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IpifyContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IpifyContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IpifyContext $ctx, $op, $args): array
    {
