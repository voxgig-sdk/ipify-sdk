...
class IpifyProxyFeature extends IpifyBaseFeature
{
    ...
    public function init(IpifyContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpifyContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
