...
class IpifyTestRunner
{
    ...
    {
        $live = self::getenv('IPIFY_TEST_LIVE');
        $override = self::getenv('IPIFY_TEST_OVERRIDE');
        ...
        $explain = self::getenv('IPIFY_TEST_EXPLAIN');
...
class_alias('IpifyTestRunner', 'Runner');
class_alias('IpifyHelpers', 'Helpers');
