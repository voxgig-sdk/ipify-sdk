...
// Ipify SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpifySDK::test)
...
{
    private const SDK_CLASS = 'IpifySDK';
    ...
    private const SDK_BASE = 'ipify_sdk';
