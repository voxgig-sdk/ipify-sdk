...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_public_ip"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.IpifySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ipify_list",
		Description: "List records from Ipify. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ipify_load",
		Description: "Load a single record from Ipify. " +
...
func runOp(client *sdk.IpifySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IpifySDK, name string) (sdk.IpifyEntity, error) {
	switch strings.ToLower(name) {
	case "get_public_ip":
		return client.GetPublicIp(nil), nil
